...
namespace BinaryHeap_11
{
    ...
    public class BinaryTree
    {
        ...
        //    s = size(this._root);
        //}
        public readonly Node[] ForWideTraverse = new Node[1];
        //public void TraverseWide()
        //{
        //    if(ForWideTraverse.Length - s < 1)
        //    {
        //        Array.Resize(ref ForWideTraverse, ForWideTraverse.Length + 1);
        //    }
